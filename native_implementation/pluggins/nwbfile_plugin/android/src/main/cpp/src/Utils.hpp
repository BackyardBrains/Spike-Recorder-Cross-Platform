 ...
 * @return The current timestamp as a string in ISO 8601 format.
 */
static inline std::string generateTimestamp()
{
...
/**
 * @brief Converts a string to a value using stringstream.
 ...
 */
static inline std::string join(const std::vector<std::string>& tokens, const std::string& delimiter)
{
  std::string result;
