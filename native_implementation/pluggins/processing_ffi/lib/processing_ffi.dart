...
const String _libName = 'processing_ffi';

/// The dynamic library in which the symbols for [ProcessingFfiBindings] can be found.
final DynamicLibrary _dylib = () {
  if (Platform.isMacOS || Platform.isIOS) {
    print('TESTL : $_libName.framework/$_libName');
...
// final ProcessingFfiBindings _bindings = ProcessingFfiBindings(_dylib);
final ProcessingBindings processingBindings = ProcessingBindings(_dylib);
