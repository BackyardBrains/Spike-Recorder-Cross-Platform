...
namespace backyardbrains {
    ...
    namespace processing {
        ...
        ThresholdProcessor::ThresholdProcessor(backyardbrains::utils::OnHeartbeatListener *listener) {
            heartbeatHelper = new backyardbrains::utils::HeartbeatHelper(getSampleRate(), listener);
        ...
        void
        ThresholdProcessor::process(short **outSamples, int *outSamplesCounts, short **inSamples,
        ...
        void
        ThresholdProcessor::prepareNewSamples(const short *inSamples, int length, int channelIndex, int sampleIndex) {
