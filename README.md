...
Windows ChromeOS 150
On Windows, Chromium+FTDI deliver much larger bursts (the existing code comments already flagged this as a known quirk), so 4096 bytes could arrive in a single burst well before the HWT: reply — even at the correct baud (222222).